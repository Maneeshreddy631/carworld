...
def inquiry(request):
    if request.method == 'POST':
        ...
        send_mail(
                'New Car Inquiry',
                'You have a new inquiry for the car ' + car_title + '. Please login to your admin panel for more info.', #concatinations+
                'shixapertures@gmail.com',
                [admin_email],
                fail_silently=False,
            )

        contact.save() #save data in db
